...
import { VideoDetailScreen } from '@/screens/sample-ui/Threads/video-detail-screen';
    ...
    if (isLoggedIn) {
      return (
        <>
          ...
          <Stack.Screen name="TokenLaunchScreen" component={TokensScreen} />

...
export const formatPnl = (value: string) => {
...
export default function LeaderBoardScreen() {
  ...
  const refferralCode = profile?.referral_code;
  console.log('referral_code: ', refferralCode);
  const privyId = user?.id;
  const referralLink = 'https://fomo.family/r/atika';

  // const referralCode = 'ATIKA';
  const handleShareReferral = async () => {
    try {
      const message = `Join me on Bags appew 🚀\n\nUse my referral code *${refferralCode}* or download the app and then enter the code:\n${referralLink}`;
          ...
          {activeTab === 'rewards' && (
            <View style={styles.rewardsWrapper}>
              ...
              <Pressable
                ...
                <Icons.ShareIcon width={18} height={18} color="#8B8BFF" />
              </Pressable>
...
const styles = StyleSheet.create({
  container: {flex: 1},
  container2: {flex: 1, padding: 16, marginTop: 10},
  ...
  segmentButton: {paddingVertical: 4, paddingHorizontal: 9, borderRadius: 10},
